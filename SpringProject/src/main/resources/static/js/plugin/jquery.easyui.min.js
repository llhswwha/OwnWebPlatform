...
(function ($) {
function changeButtonClass(linkBtn) {
    linkBtn.removeClass("l-btn");
    linkBtn.addClass("l-btn-pager");
}
function _80(_81){
...
changeButtonClass(a.linkbutton($.extend({}, btn, { plain: true })));
}
}
}else{
var td=$("<td></td>").appendTo(tr);
...
a.wrap("<td></td>");
changeButtonClass(a.linkbutton({ iconCls: btn.iconCls, plain: true }).unbind(".pagination").bind("click.pagination", function () {
...
changeButtonClass(a.linkbutton({ plain: true, text: i }));

if(i==_95.pageNumber){
    changeButtonClass(a.linkbutton("select"));
}else{
...
if(bb.first){
    changeButtonClass(bb.first.linkbutton({disabled:(_95.pageNumber==1)}));
}
if(bb.prev){
    changeButtonClass(bb.prev.linkbutton({disabled:(_95.pageNumber==1)}));
}
if(bb.next){
    changeButtonClass(bb.next.linkbutton({disabled:(_95.pageNumber==_96)}));
}
if(bb.last){
    changeButtonClass(bb.last.linkbutton({disabled:(_95.pageNumber==_96)}));
}
_9a(_92,_95.loading);
};
...
if(_9e.showRefresh&&_9d.bb.refresh){
    changeButtonClass(_9d.bb.refresh.linkbutton({ iconCls: (_9e.loading ? "pagination-loading" : "pagination-load") }));
}
};
...
var node=jq.tree("getEntityData",_18d);
jq.tree("remove",_18d);
return node;
...
for(var _275 in _274){
    var btn=$("<a></a>").attr("href", "javascript:void(0)").text(_275).css("margin-left", 10).bind("click", eval(_274[_275])).appendTo(tb).linkbutton();
    //console.log("Confirm LinkButton:" + _275);
    //console.log(btn);
    btn.removeClass("l-btn");
    btn.addClass("l-btn-messager");
}
}
...
var data=$(_724).treegrid("getEntityData");
_752(_724,0,data);
}
...
cc=$(_79f).treegrid("getEntityData");
}
for(var i=0;i<cc.length;i++){
